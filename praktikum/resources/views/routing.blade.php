...
<body>
    <div class="container m-5">
        ...
        <div class="list-group list-group-numbered mt-4">
            ...
            <a href="{{ url('/user/12345') }}" class="list-group-item list-groupitem-action">Route Parameter (Required
                Parameter) - 1
            </a>
...
list-group-item-action">
        ...
        <div class="list-group list-group-numbered mt-4">
            ...
            <a href="{{ route('admin.users') }}" class="list-group-item list-groupitem-action">
                Admin Users
            </a>
            <a href="{{ route('admin.items') }}" class="list-group-item list-groupitem-action">
                Admin Items
            </a>
        </div>
