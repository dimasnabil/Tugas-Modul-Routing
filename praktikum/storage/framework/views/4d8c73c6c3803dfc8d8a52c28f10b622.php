...
<body>
    ...
    <nav class="navbar fixed-top navbar-expand-lg bg-purple" data-bs-theme="dark">
        ...
        <div class="container py-2 px-4">
            ...
            <a href="#" class="navbar-brand mb-0 h1">
                <img class="img-fluid" src="<?php echo e(Vite::asset('../images/logowhite.svg')); ?>" alt="logo"
                    style="width: 40px;">
            </a>
            <!-- Navbar Toggler -->
    ...
    d-md-none">Github</small>
                        ...
                        <li class="nav-item col-6 col-md-auto">
                            <a href="#" class="nav-link active"><i class="bi-twitter"></i><small
                                    class="ms-2
    ...
    text-white"></i>
                    ...
                    <h2 class="display-5 mb-3">Personalize it with <br />Bootstrap
                        Icons</h2>
                    <p class="fs-5"><a href="#">Bootstrap Icons</a> is an open sourceSVG icon library
                        featuring over
                        1,800 glyphs, with more added every release.
...
<?php /**PATH C:\xampp\htdocs\praktikum\resources\views/clone_bootstrap.blade.php ENDPATH**/ ?>